...
function Header() {
  ...
  return (
    <header className="w-full sticky top-0 px-3 py-2 flex justify-between items-center gap-4 border-b border-zinc-200">
      ...
      <nav className="transition-all duration-300 flex items-center gap-6">
